    ...
    "tec-suite": {
        ...
        "flags": [
            ...
            },
            {
                ...
                "default": 1,
                "required": False,
                "help": "Number of day folders to process in parallel (default 1).",
                "min": 1,
                "max": 64,
            },
            {
                ...
                "default": "",
                "required": False,
                "help": "Optional day selection list/range, e.g. 1-5,10,12-14.",
            },
            {
                "name": "-v",
                "long": "--verbose",
    ...
    "dat-parquet-handler": {
        ...
        "flags": [
            ...
            },
            {
                "name": "--day-from",
                "long": "--day-from",
                "label": "Day From (inclusive)",
                "type": "number",
                "default": "",
                "required": False,
                "help": "Optional inclusive start day-of-year filter (1..366).",
                "min": 1,
                "max": 366,
            },
            {
                "name": "--day-to",
                "long": "--day-to",
                "label": "Day To (inclusive)",
                "type": "number",
                "default": "",
                "required": False,
                "help": "Optional inclusive end day-of-year filter (1..366).",
                "min": 1,
                "max": 366,
            },
        ],
